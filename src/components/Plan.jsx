...
const Plan = () => {
  return (
    <div className='w-full h-full px-6 lg:px-20 py-14 lg:py-28 bg-[#FFD6D6]'>
        ...
        <div className='flex flex-row items-center justify-center mt-6 gap-6 bg-white p-2 border border-white rounded-lg w-[80%] lg:w-[22%] mx-auto'>
