...
const Plan = () => {
  return (
    <div className='w-full h-full px-14 py-6'>
        ...
        <div className='flex flex-row items-center justify-center mt-4 bg-white p-5 border border-white rounded-lg'>
            <button>Bill Monthly</button>
            <button className='bg-[#54BD95] py-3 px-4 rounded-lg text-white text-lg'>Bill Yearly</button>
        </div>
    </div>
  )
}
